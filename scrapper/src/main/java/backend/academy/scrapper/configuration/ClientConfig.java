...
public class ClientConfig {
    ...
    public GithubClient githubClient() {
        return buildHttpInterface(
                applicationConfig.githubClient().api(),
                GithubClient.class,
    ...
    public StackoverflowClient stackoverflowClient() {
        return buildHttpInterface(
                applicationConfig.stackoverflowClient().api(),
    ...
    public BotClient botClient() {
        return buildHttpInterface(
                applicationConfig.botClient().api(),
                BotClient.class,
    ...
    private <T> T buildHttpInterface(String baseUrl, Class<T> serviceType, ScrapperConfig.RetryConfig retryConfig) {
        WebClientAdapter webClientAdapter = WebClientAdapter.create(WebClient.builder()
                .baseUrl(baseUrl)
